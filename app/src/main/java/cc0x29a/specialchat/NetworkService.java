...
public class NetworkService extends Service{
	...
	public void onCreate(){
		...
		final someMethods methods=new someMethods();
	...
	public class someMethods{
		...
		private void refreshNewMsg(){
			...
			new Thread(new Runnable(){
				@Override
				public void run(){
					String DataSend="{"+"\"client\":\"SCC-1.0\","+"\"action\":\"0003\","+"\"user_id\":\""+user_id+"\","+"\"token_key\":\""+token_key+"\","+"\"timestamp\":\""+MyTools.getCurrentTime()+"\""+"}";
